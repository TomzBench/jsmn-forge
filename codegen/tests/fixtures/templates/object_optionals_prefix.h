...
union maybe__fooey_thing_nested {
    struct fooey_thing_nested value;
};

struct optional__fooey_thing_nested {
    bool present;
    union maybe__fooey_thing_nested maybe;
};
...
struct fooey_thing {
    ...
    struct optional__fooey_thing_nested nested;
